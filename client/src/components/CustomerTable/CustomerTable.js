    ...
    return (
      <div>
        ...
        <ResponsiveTableWrapper
          ...
          <Column
            columnKey='GivenName'
            header={<SortHeaderCell {...headerCellProps}> Given Name </SortHeaderCell>}
            cell={<DataCell data={data} />}
            flexGrow={1}
            width={100} />
          <Column
            columnKey='FamilyName'
            header={<SortHeaderCell {...headerCellProps}> Family Name </SortHeaderCell>}
            cell={<DataCell data={data} />}
            flexGrow={1}
            width={100} />
          <Column
            columnKey='FullyQualifiedName'
            header={<SortHeaderCell {...headerCellProps}> Fully Qualified Name </SortHeaderCell>}
            cell={<DataCell data={data} />}
            flexGrow={3}
            width={100} />
        </ResponsiveTableWrapper>
